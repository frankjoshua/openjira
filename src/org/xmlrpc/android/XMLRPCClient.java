...
import org.alexdalton.jira.utils.ConnectionClient;
...
public class XMLRPCClient extends XMLRPCCommon {
    ...
    public XMLRPCClient(URI uri) {
        ...
        try {
            client = new ConnectionClient(null, 443);
        } catch (Exception e) {
...
// reader = new StringReader("<?xml version='1.0'?><methodResponse><params><param><value>\n\n\n</value></param></params></methodResponse>");
    ...
    public static class _FakeX509TrustManager implements X509TrustManager {
        ...
        private final static X509Certificate[] _AcceptedIssuers = new X509Certificate[] {};
